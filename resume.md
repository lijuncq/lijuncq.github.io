...
3. 相应工程软件(PDMS, Tekla, Navisworks)技术支持,参数化设计及二次开发(C#, pml, python)。
...
1. 全厂大件设备运输及吊装方案。相应临时结构设计计算。 2. 现场管道设计管理。
...
项目管理, 电厂,脱硫,铝业布置及管道设计

PDMS/E3D, Navisworks, Tekla, AutoCAD, Pro/E

C#, Python, pml/pml.net, JavaScript
...
精通PDMS, Tekla, Navisworks及其二次开发, 熟悉pml, pml.net, c#, JavaScript, python等开发语言。 进入链接 [https://lijuncq.github.io/works.html](https://lijuncq.github.io/works.html)可查看我编写的部分插件。
